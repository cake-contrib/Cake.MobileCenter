...
{
	/// <summary>
	/// Settings for mobile-center test run uitest.
	/// Starts a test run with Xamarin UI Tests..
	/// </summary>
	[CompilerGenerated]
	public sealed class MobileCenterTestRunUitestSettings : AutoToolSettings
	{
		/// <summary>
		/// --devices &lt;arg&gt;
		...
		/// <summary>
		/// --language &lt;arg&gt;
		/// Override the language (iOS only) for the
		/// </summary>
