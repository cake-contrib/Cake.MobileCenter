...
{
	/// <summary>
	/// Settings for mobile-center setup-autocomplete.
	/// Setup autocompletion for the shell.
	/// </summary>
	[CompilerGenerated]
	public sealed class MobileCenterSetupAutocompleteSettings : AutoToolSettings
	{
		/// <summary>
		/// -s|--shell &lt;arg&gt;
		/// Shell to generate autocompletion code for.
		/// </summary>
